...
export class KaraokeUIManager extends Component {
    ...
    public showPlayingState() {
        ...
        // This would show all karaoke elements as per wireframe
    }
    ...
    // =========================================================================
    // LYRICS COMPONENT FUNCTIONALITY
    // =========================================================================
     ...
     */
    public updateMicVisualization(result: PitchDetectionResult) {
